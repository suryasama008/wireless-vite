...
function validateSetOptions(methodName, options) {
  ...
  if (options.mergeFields !== void 0 && options.merge !== void 0) {
    throw new L2("invalid-argument", `Invalid options passed to function ${methodName}(): You cannot specify both "merge" and "mergeFields".`);
  }
  return options;
}
function assertUint8ArrayAvailable() {
  if (typeof Uint8Array === "undefined") {
    throw new L2("unimplemented", "Uint8Arrays are not available in this environment.");
  }
}
function assertBase64Available() {
  if (!Gt()) {
    throw new L2("unimplemented", "Blobs are unavailable in Firestore in this environment.");
  }
}
var Blob = class {
  ...
  static fromBase64String(base64) {
    ...
    return new Blob(Ih.fromBase64String(base64));
  }
  static fromUint8Array(array) {
    assertUint8ArrayAvailable();
    return new Blob(Ih.fromUint8Array(array));
  }
  toBase64() {
    assertBase64Available();
...
var Firestore = class {
  ...
  settings(settingsLiteral) {
    ...
    if (!settingsLiteral.merge && currentSettings.host !== settingsLiteral.host) {
      N2("You are overriding the original host. If you did not intend to override your settings, use {merge: true}.");
    }
  ...
  enablePersistence(settings) {
    ...
    if (settings) {
      ...
      ca2("synchronizeTabs", synchronizeTabs, "experimentalForceOwningTab", experimentalForceOwningTab);
    }
  ...
  get app() {
    if (!this._appCompat) {
      throw new L2("failed-precondition", "Firestore was not initialized using the Firebase SDK. 'app' is not available");
    }
    return this._appCompat;
  }
  collection(pathString) {
    try {
      return new CollectionReference(this, Ta2(this._delegate, pathString));
    } catch (e) {
  ...
  doc(pathString) {
    try {
      return new DocumentReference(this, Aa2(this._delegate, pathString));
    } catch (e) {
  ...
  collectionGroup(collectionId) {
    try {
      return new Query(this, Ea2(this._delegate, collectionId));
    } catch (e) {
  ...
  namedQuery(name2) {
    return yh(this._delegate, name2).then((expQuery) => {
      if (!expQuery) {
        return null;
      }
      return new Query(
...
var Transaction = class {
  ...
  get(documentRef) {
    ...
    return this._delegate.get(ref).then((result) => new DocumentSnapshot(this._firestore, new Dl(this._firestore._delegate, this._userDataWriter, result._key, result._document, result.metadata, ref.converter)));
  }
...
var DocumentReference = class {
  ...
  static forPath(path, firestore, converter) {
    if (path.length % 2 !== 0) {
      throw new L2("invalid-argument", `Invalid document reference. Document references must have an even number of segments, but ${path.canonicalString()} has ${path.length}`);
    }
    return new DocumentReference(firestore, new ya2(firestore._delegate, converter, new ct(path)));
  }
  static forKey(key, firestore, converter) {
    return new DocumentReference(firestore, new ya2(firestore._delegate, converter, key));
  }
  get id() {
  ...
  collection(pathString) {
    try {
      return new CollectionReference(this.firestore, Ta2(this._delegate, pathString));
    } catch (e) {
  ...
  isEqual(other) {
    ...
    if (!(other instanceof ya2)) {
      return false;
    }
    return Ra2(this._delegate, other);
  }
  set(value, options) {
...
var Query = class {
  ...
  where(fieldPath, opStr, value) {
    try {
      return new Query(this.firestore, sl(this._delegate, rl(fieldPath, opStr, value)));
    } catch (e) {
  ...
  orderBy(fieldPath, directionStr) {
    try {
      return new Query(this.firestore, sl(this._delegate, hl(fieldPath, directionStr)));
    } catch (e) {
      throw replaceFunctionName(e, /(orderBy|where)\(\)/, "Query.$1()");
    }
  }
  limit(n) {
    try {
      return new Query(this.firestore, sl(this._delegate, fl(n)));
    } catch (e) {
  ...
  limitToLast(n) {
    try {
      return new Query(this.firestore, sl(this._delegate, dl(n)));
    } catch (e) {
  ...
  startAt(...args) {
    try {
      return new Query(this.firestore, sl(this._delegate, wl(...args)));
    } catch (e) {
  ...
  startAfter(...args) {
    try {
      return new Query(this.firestore, sl(this._delegate, ml(...args)));
    } catch (e) {
  ...
  endBefore(...args) {
    try {
      return new Query(this.firestore, sl(this._delegate, yl(...args)));
    } catch (e) {
  ...
  endAt(...args) {
    try {
      return new Query(this.firestore, sl(this._delegate, pl(...args)));
    } catch (e) {
      throw replaceFunctionName(e, "endAt()", "Query.endAt()");
    }
  }
  isEqual(other) {
    return ba2(this._delegate, other._delegate);
  }
  get(options) {
    let query;
    if ((options === null || options === void 0 ? void 0 : options.source) === "cache") {
      query = Ll(this._delegate);
    } else if ((options === null || options === void 0 ? void 0 : options.source) === "server") {
      query = ql(this._delegate);
    } else {
      query = Bl(this._delegate);
    }
    return query.then((result) => new QuerySnapshot(this.firestore, new xl(this.firestore._delegate, this._userDataWriter, this._delegate, result._snapshot)));
  }
  onSnapshot(...args) {
    const options = extractSnapshotOptions(args);
...
var CollectionReference = class extends Query {
  ...
  doc(documentPath) {
    try {
      if (documentPath === void 0) {
        return new DocumentReference(this.firestore, Aa2(this._delegate));
      } else {
        return new DocumentReference(this.firestore, Aa2(this._delegate, documentPath));
      }
    } catch (e) {
  ...
  isEqual(other) {
    return Ra2(this._delegate, other._delegate);
  }
  withConverter(converter) {
