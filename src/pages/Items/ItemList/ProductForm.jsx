          ...
          <tr>
            ...
            <td className='text-start'>{product?.battery}</td>
              ...
              {(addProducts || []).map((formRow, key) => (
                  ...
                  {showLabelPrint && (
                    <div className='mx-4'>
                 <div className='m-4' style={{ border: '5px solid black' , margin: '50px'}} ref={componentRef}>
                 <div className='text-center border border-3'>
                 <div className='text-center black-text' style={{borderBottom: '2px solid black' , fontSize: '18px'}}><b>{product?.model}</b></div>
                 <div className='text-center black-text' style={{borderBottom: '2px solid black', fontSize: '18px'}}><b>$ {product?.sellingPrice}</b></div>
                 <div className='text-center black-text' style={{borderBottom: '2px solid black', fontSize: '18px' }}><b>{product?.storage} - {product?.condition} - {product?.battery}%</b></div>
                 <div className='text-center mt-2'>
                   <Barcode imei={printImei ? printImei : addProducts[0].imei} />
                 </div>
              ...
              <Card>
                ...
                <div>
                    <Row >
                      ...
                      <Col md={6}>
                        <div className="mb-3">
                          <Label htmlFor="formrow-password-Input">Employee Name</Label>
                          <input
                            className='form-control'
                            type='Name'
                            placeholder='Name'
                    ...
                    <div style={{ borderBottom: '1px solid #D3D3D3', color:'#808080'}} className = 'mb-4 mt-2 text-center'>
                    ...
                    <Row>
                      <Col lg={12}>
                        <div className="mb-3">
                          <Label htmlFor="formrow-InputZip">IMEI / Serial Number</Label>
                          {id ? (
                                <input
                                  className='form-control'
                                  type='text'
                                            ...
                                            <Row className='mb-2'>
                                              <Col md='10'>
                                                <Input
                                                  ...
                                                  onChange={(event) =>
                                                    addImei(event.target.value.toUpperCase(), key)
                                                  }
                                                />
                                              </Col>
                                              <Col md='2'>
                    ...
                    <Row className = 'm-4 d-flex justify-content-between'>
                      <Col lg={4}>
                      <button  className="btn btn-danger w-md mt-4" onClick = {() => setProduct({})}>
                        Clear
                      </button>
                      </Col>
                      <Col lg={4}>
                      ...
                      <Col lg={4}>
                      <Button color='primary' className='mt-4 w-md' onClick={id ? handleUpdate : handleSubmit}>
                        Submit
                      </Button>
                      </Col>
                    </Row>
