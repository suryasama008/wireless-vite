...
import userImg from "/src/assets/images/jobs.png"
import {
...
const Chat = props => {
  ...
  //meta title
  document.title = "Chat | Wireless + - Vite React Admin & Dashboard Template";
  ...
  return (
    <React.Fragment>
      <div className='page-content'>
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumbs title='Wireless +' breadcrumbItem='Chat' />
                            ...
                            <PerfectScrollbar style={{ height: '410px' }}>
                              {contacts &&
                                contacts.map((contact) => (
                                  ...
                                  >
                                    <div className='mb-3'>
                                      <span className='avatar-title bg-primary bg-soft text-primary'>
                                        {contact.category}
                                      </span>
                                    </div>
