...
const Transactions = ({items}) => {
  ...
  console.log(items)
const filterTodaysItems = () => {
  const toronto = new Intl.DateTimeFormat('en-US', {
    timeZone: 'America/Toronto',
  })
  const today = new Date(toronto.resolvedOptions().timeZone)
  ...
  return items.filter((item) => {
    ...
    return (
      itemDate >= todayStart && itemDate < todayEnd 
    )
  })
}


console.log(filterTodaysItems())
