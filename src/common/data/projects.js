...
const projects = [
  {
    ...
    files: [
      { name: "Wireless + Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Wireless + Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Wireless + Logo.Zip", size: "2.02 MB", link: "#" },
